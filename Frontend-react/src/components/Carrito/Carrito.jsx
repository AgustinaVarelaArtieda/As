...
import { Typography, Box, Button, IconButton, Table, TableContainer, TableBody, TableRow, TableCell, Grid, TableHead, Collapse} from "@mui/material";
    ...
    return (
        ...
        {carrito.length === 0 ? (
                <Box sx={{ display: "flex", flexDirection: "column", alignItems: "center", mt:10, mb:4 }}>
                    <Typography variant="h3" align='center'>Agrega impresiones a tu carrito!</Typography>
                    <Button variant="contained" sx={{m:2}} onClick={handleExpandClick}>Buscar impresiones</Button>
